...
export const ChallengesPage: React.FC = () => {
  ...
  const handleEditChallenge = (e: React.MouseEvent, id: string) => {
    e.preventDefault();
    e.stopPropagation(); // Изолируем клик от внешнего Link
    // Навигация на страницу изменения настроек самого челленджа
      ...
      <div className={styles['challenges-page__content']}>
        ...
        <div className="d-flex flex-column gap-3">
          {challenges.map((challenge) => (
            /* Оборачиваем каждую плашку в Link для перехода на страницу этого челленджа */
            <Link 
              key={challenge.id} 
            ...
            >
              <div className={styles['challenge-row']}>
                <div className="row g-0 align-items-center w-full h-100">
                  ...
                  {/* Инфо: Текст названия (UPPERCASE) + Сложность */}
                  ...
                  {/* Кнопки управления справа (Удалить + Редактировать) */}
                  <div className="col-auto pe-3 d-flex align-items-center gap-2">
                    ...
                    <button 
                      className={styles['challenge-row__action-btn']}
                      onClick={(e) => handleEditChallenge(e, challenge.id)}
                    >
                      <svg viewBox="0 0 24 24" fill="none">
